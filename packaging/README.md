...
- **补丁面**：`verify-patches-v2.sh` **40 锚点**（2026-09-20 增补 identity×2）ALL VERIFIED（含 G1 HMR 生产守卫 / G2 console 转发，见 [ADR-0065](../docs/adr/ADR-0065.md)）；`runtime-guards/apply-fixes.sh` 管理 G1/G2 的重放与体检。
