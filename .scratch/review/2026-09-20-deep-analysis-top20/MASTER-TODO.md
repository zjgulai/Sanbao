...
第二批（DA-22~DA-41，薄壳骨架健康诊断）已立项，见
[../2026-09-22-arch-health-top20/MASTER-TODO.md](../2026-09-22-arch-health-top20/MASTER-TODO.md)。
本批遗留的 open / in-progress / local-done 项在新批中的归宿：
DA-07 剩余热点 → DA-31；DA-13 → DA-35；DA-18 → DA-36；DA-06/10/21 实机读数欠账 → DA-34 一次收口；
DA-08 留档的 42 spec / 点名 10 可达性读数 → DA-29 批量接线。
