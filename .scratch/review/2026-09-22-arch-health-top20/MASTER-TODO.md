...
| [DA-24](tasks/DA-24-optional-service-failure-audit.md) | 可选服务保守失败态抽查（ADR-0038 模式复检） | P2 | S | DA-22 | `done`（09-22，EX-08：fail-open 终扫零命中；栅栏 fail-closed 有具名负例测试；放行型缺陷清零） |
