...
- EX-05 收口 · 2026-09-23 · DA-29 done：用户拍板处置 A——002/003/004/005/008/009 六条 runTier 改 `'full'`（登记表头注释落语义定义），001/003A/006/007/011 保持 quick；security-contract-master 审计 11/11 + selftest 6/6 绿。登记与执行路径一致，本卡收口。
- EX-04 事故后续跑 · 2026-09-23 · DA-25 保持 open：只读对账后，用户授权的最小生产恢复已执行并实机验收；未安装依赖或改锁，临时 CDP 已关闭，实机消融仍未执行。恢复结果与残余统一见 [DA-25 最小生产恢复](tasks/DA-25-capability-ablation-matrix.md#最小生产恢复2026-09-23用户单独授权后执行)。
