...
import { editablePlan, messageOf, reportExportContent, reachableStep, stepFor, type EditableQuestion, type ResearchEvidenceView, type ResearchStep, type Translate } from './research-view-model.ts'
...
export function useResearchWorkspace({ project, api, t, onChange, setError }: ResearchWorkspaceOptions) {
...
export function useReportExport({ project, accepted, t }: { project: ResearchProject; accepted: ResearchEvidenceView[]; t: Translate }) {
