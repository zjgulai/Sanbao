...
function PlanStep({ project, t, busy, goal, setGoal, questions, setQuestions, onSave, onConfirm, onRetry }) {
    ...
    return _jsxs("section", { className: css.planPane, children: [_jsxs("div", { className: css.sectionHeader, children: [_jsxs("div", { children: [_jsx("p", { className: css.planEyebrow, children: t('plan.title') }), _jsx("h3", { className: css.planQuestionTitle, children: project.question }), _jsx("p", { children: t('plan.subtitle') })] }), _jsxs("div", { className: css.headerActions, children: [_jsx("span", { className: css.planDepth, children: `${t('composer.depth')} · ${depthLabel(project.depth, t)}` }), project.planConfirmed
                        ...
                        return _jsxs("section", { className: css.planQuestion, children: [_jsx("span", { children: ordinal(index) }), _jsxs("div", { children: [project.planConfirmed
                                            ...
                                            : _jsxs("label", { children: [t('plan.criteria'), _jsx("textarea", { value: question.criteria.join('\n'), disabled: busy, onChange: event => { updateQuestion(index, { criteria: event.target.value.split('\n') }); } })] }), deps.length === 0 ? null : _jsxs("div", { className: css.depBlock, children: [_jsx("span", { className: css.depLabel, children: t('plan.dependsOn') }), _jsx("div", { className: css.depChips, children: deps.map(dep => _jsx("span", { className: css.depChip, children: t('plan.dependsOnChip', { label: formatDepLabel(dep, questions[dep]?.text ?? '') }) }, `${index}-${dep}`)) }), _jsx("small", { className: css.depHint, children: t('plan.dependsOnHint') })] }), !project.planConfirmed ? _jsxs("div", { className: css.planActionRow, children: [_jsx("span", {}), _jsx("button", { className: css.exportButton, type: "button", disabled: busy || questions.length <= 1, onClick: () => { setQuestions(curr => curr.filter((_, i) => i !== index)); }, children: t('plan.removeQuestion') })] }) : null] })] }, `${project.id}-${index}`);
                    }), !project.planConfirmed ? _jsx("div", { style: { padding: '16px 0' }, children: _jsxs("button", { className: css.secondaryButton, type: "button", disabled: busy, onClick: () => { setQuestions(curr => [...curr, { text: '新增补充子问题', criteria: ['核验该子问题关联的权威事实'], dependsOn: [] }]); }, children: [_jsx(IconPlus, { size: 14 }), t('plan.addQuestion')] }) }) : null] })] });
}
...
function ReportPane({ project, t, busy, onRewrite }) {
    ...
    return _jsxs("section", { className: css.reportPane, children: [_jsxs("div", { className: css.sectionHeader, children: [_jsxs("div", { children: [_jsx("h3", { children: t('report.title') }), _jsx("p", { children: t('report.subtitle') })] }), _jsxs("div", { className: css.headerActions, children: [project.report ? _jsxs("div", { className: css.exportButtonGroup, children: [_jsx("button", { className: css.exportButton, type: "button", onClick: () => { handleExport('md'); }, children: t('report.exportMarkdown') }), _jsx("button", { className: css.exportButton, type: "button", onClick: () => { handleExport('html'); }, children: t('report.exportHtml') }), _jsx("button", { className: css.exportButton, type: "button", onClick: () => { handleExport('mindmap'); }, children: t('report.exportMindmap') })] }) : null, project.planConfirmed && !writing ? _jsx("button", { className: css.primaryButton, type: "button", disabled: busy, onClick: onRewrite, children: project.report ? t('report.retry') : t('investigate.writeReport') }) : null] })] }), copyNotice ? _jsxs("div", { className: css.confirmed, style: { margin: '8px 0' }, children: [_jsx(IconCheck, { size: 14 }), copyNotice] }) : null, project.report ? _jsxs("div", { className: css.executiveCard, children: [_jsxs("h4", { children: [_jsx(IconBolt, { size: 14 }), t('report.executiveSummary')] }), _jsx("p", { children: project.goal ? `围绕核心命题「${project.question}」，基于已穿透核验的 ${accepted.length} 项多方信源证据生成全景研报。` : project.question }), _jsxs("ul", { className: css.takeawayList, children: [_jsxs("li", { className: css.takeawayItem, children: [_jsx("b", { children: "\uD83C\uDFAF \u7814\u7A76\u6838\u5FC3" }), _jsx("span", { children: project.question })] }), _jsxs("li", { className: css.takeawayItem, children: [_jsx("b", { children: "\uD83D\uDD0D \u8BC1\u636E\u8986\u76D6" }), _jsxs("span", { children: [accepted.length, " \u6761\u5DF2\u6838\u9A8C\u8BC1\u636E\u94FE \u00B7 ", project.questions.length, " \u4E2A\u5B50\u9886\u57DF"] })] }), _jsxs("li", { className: css.takeawayItem, children: [_jsx("b", { children: "\u26A1 \u7814\u5224\u7F6E\u4FE1\u5EA6" }), _jsx("span", { children: accepted.some(a => a.confidence === 'high') ? '高 (多方独立交叉验证通过)' : '中 (基线证据充足)' })] })] })] }) : null, project.report !== null
                ? _jsx("article", { className: `${css.reportDocument} ${css.auroraGlow}`, children: _jsx(MarkdownText, { text: project.report, streaming: writing, labels: markdownLabels }) })
                : writing
