...
export const zh = {
  ...
  'entry.label': '扩展中心',
  'entry.tooltip': '扩展中心：管理 Agent 技能、MCP 工具与应用扩展',
  'panel.title': '扩展中心',
  'panel.subtitle': '管理 Agent 技能、MCP 工具与企业应用扩展',
  'tab.skills': 'Agent 技能包',
  'tab.mcp': 'MCP 服务',
  'tab.apps': '应用扩展',
  'tab.all': '全部扩展',
  'card.run': '执行',
  'card.runParamPlaceholder': '输入执行参数或诉求（回车或点击执行发送到会话）…',
  'card.runSending': '正在唤醒会话…',
  'card.runSuccess': '已发送到会话！',
  'card.runDirect': '一键运行',
  'search.placeholder': '搜索技能与扩展（名称 / 场景 / 关键词）…',
  'search.empty': '没有找到匹配的扩展能力。换个关键词试试？',
  'domain.all': '全部',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'entry.label': 'Extensions Hub',
  'entry.tooltip': 'Extensions Hub: Manage Agent Skills, MCP Tools & Apps',
  'panel.title': 'Extensions Hub',
  'panel.subtitle': 'Manage Agent Skills, MCP Tools & Apps',
  'tab.skills': 'Agent Skills',
  'tab.mcp': 'MCP Services',
  'tab.apps': 'Applications',
  'tab.all': 'All Extensions',
  'card.run': 'Run',
  'card.runParamPlaceholder': 'Enter parameters or prompt (press Enter to send to chat)…',
  'card.runSending': 'Waking up session…',
  'card.runSuccess': 'Sent to chat!',
  'card.runDirect': 'Quick Run',
  'search.placeholder': 'Search extensions (name / scenario / keyword)…',
  'search.empty': 'No matching extensions found. Try another keyword?',
  'domain.all': 'All',
