...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var TB_CSS = [
			...
			'.dsh-tb-shell { height:100%; display:flex; flex-direction:column; overflow:hidden; color:var(--dsw-alias-label-primary); background:var(--dsw-alias-bg-base); font-family:var(--dsw-font-family, system-ui, sans-serif); font-size:12px; }',
			'.dsh-tb-header { display:flex; align-items:center; gap:12px; min-height:48px; padding:8px 14px; background:var(--dsw-alias-bg-layer-1); border-bottom:1px solid var(--dsw-alias-border-l1); justify-content:space-between; }',
			...
			'.dsh-tb-error { margin:8px 12px 0; padding:8px 10px; color:var(--dsw-alias-state-error-primary); border:1px solid color-mix(in srgb, var(--dsw-alias-state-error-primary) 55%, var(--dsw-alias-border-l1)); border-radius:var(--dsw-alias-radius-sm, 6px); background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 8%, var(--dsw-alias-bg-layer-1)); font-size:12px; }',
			'.dsh-tb-viewport { position:relative; flex:1; min-height:0; overflow:auto; background:var(--dsw-alias-bg-base); }',
			'.dsh-tb-canvas { position:relative; min-width:100%; min-height:100%; }',
			'.dsh-tb-panel { position:absolute; z-index:2; padding:12px; border:1px solid var(--dsw-alias-border-l1); border-radius:var(--dsw-alias-radius-md, 10px); background:var(--dsw-alias-bg-layer-1); box-shadow:var(--dsw-alias-shadow-md, 0 8px 24px rgba(0,0,0,.16)); }',
			'.dsh-tb-main-panel, .dsh-tb-child-panel { background:var(--dsw-alias-bg-layer-1); }',
			...
			'.dsh-tb-links path { fill:none; stroke:var(--dsw-alias-brand-primary); stroke-width:1.5; stroke-dasharray:6 7; stroke-linecap:round; opacity:.58; }',
			...
			'.dsh-tb-drag-handle { margin:-12px -12px 10px; padding:10px 12px 9px; border-bottom:1px solid var(--dsw-alias-border-l1); border-radius:var(--dsw-alias-radius-md, 10px) var(--dsw-alias-radius-md, 10px) 0 0; cursor:grab; touch-action:none; user-select:none; }',
			'.dsh-tb-collapsed .dsh-tb-drag-handle { margin-bottom:0; border-bottom:0; border-radius:var(--dsw-alias-radius-md, 10px); }',
			'.dsh-tb-drag-handle:active { cursor:grabbing; }',
			'.dsh-tb-collapse { display:grid; width:24px; min-width:24px; height:24px; min-height:24px; padding:0; place-items:center; color:var(--dsw-alias-label-secondary); border:1px solid var(--dsw-alias-border-l1); border-radius:var(--dsw-alias-radius-sm, 6px); background:var(--dsw-alias-bg-layer-2); font:16px/1 "SF Mono", Menlo, monospace; cursor:pointer; }',
			...
			'.dsh-tb-add-root { display:grid; width:32px; height:32px; margin:2px auto 0; padding:0; place-items:center; color:var(--dsw-alias-brand-primary); border:1px dashed var(--dsw-alias-brand-primary); border-radius:50%; background:var(--dsw-alias-bg-layer-1); font:20px/1 "SF Mono", Menlo, monospace; cursor:pointer; }',
			'.dsh-tb-add-root:hover { color:var(--dsw-alias-bg-layer-1); background:var(--dsw-alias-brand-primary); }',
			'.dsh-tb-root-create { display:flex; flex-direction:column; gap:8px; padding:10px; border:1px dashed var(--dsw-alias-brand-primary); border-radius:var(--dsw-alias-radius-sm, 6px); background:var(--dsw-alias-bg-layer-1); }',
			'.dsh-tb-root-create input, .dsh-tb-manual-dialog input, .dsh-tb-manual-dialog textarea { width:100%; box-sizing:border-box; padding:0 9px; color:var(--dsw-alias-label-primary); border:1px solid var(--dsw-alias-border-l1); border-radius:var(--dsw-alias-radius-sm, 6px); outline:0; background:var(--dsw-alias-bg-base); font-size:13px; }',
			...
			'.dsh-tb-root-create button { min-height:29px; padding:3px 9px; color:var(--dsw-alias-label-primary); border:1px solid var(--dsw-alias-border-l1); border-radius:var(--dsw-alias-radius-sm, 6px); background:var(--dsw-alias-bg-layer-1); cursor:pointer; }',
			'.dsh-tb-root-create button:first-child { color:var(--sanbao-on-accent); border-color:var(--sanbao-accent-fill); background:var(--sanbao-accent-fill); }',
			'.dsh-tb-root-create button:disabled { opacity:.45; cursor:not-allowed; }',
			'.dsh-tb-card { min-height:126px; padding:10px; border:1px solid var(--dsw-alias-border-l1); border-radius:var(--dsw-alias-radius-sm, 6px); background:var(--dsw-alias-bg-layer-1); transition:border-color 180ms ease, background-color 180ms ease; }',
			'.dsh-tb-card:hover { border-color:var(--dsw-alias-brand-primary); background:var(--dsw-alias-interactive-bg-hover, var(--dsw-alias-bg-layer-1)); }',
			'.dsh-tb-card.dsh-tb-completed { border-color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 60%, var(--dsw-alias-border-l1)); background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 8%, var(--dsw-alias-bg-layer-1)); }',
			'.dsh-tb-card-temporary { min-height:112px; border-style:dashed; background:color-mix(in srgb, var(--dsw-alias-state-warn-primary) 8%, var(--dsw-alias-bg-layer-1)); }',
			...
			'.dsh-tb-card-actions button { min-height:28px; padding:3px 8px; color:var(--dsw-alias-label-secondary); border:1px solid var(--dsw-alias-border-l1); border-radius:var(--dsw-alias-radius-sm, 6px); background:transparent; font-size:10px; cursor:pointer; }',
			...
			'.dsh-tb-nested-panel { display:flex; flex-direction:column; gap:8px; margin:10px 0 0 17px; padding:8px; border-left:1.5px dashed var(--dsw-alias-brand-primary); border-radius:0 var(--dsw-alias-radius-sm, 6px) var(--dsw-alias-radius-sm, 6px) 0; background:color-mix(in srgb, var(--dsw-alias-bg-layer-2) 45%, transparent); }',
			'.dsh-tb-nested-panel > span { color:var(--dsw-alias-brand-primary); font-size:10px; font-weight:700; }',
			'.dsh-tb-temporary-panel { display:flex; flex-direction:column; gap:8px; margin:10px 0 0 17px; padding:8px; border-left:1.5px dashed var(--dsw-alias-state-warn-primary); border-radius:0 var(--dsw-alias-radius-sm, 6px) var(--dsw-alias-radius-sm, 6px) 0; background:color-mix(in srgb, var(--dsw-alias-state-warn-primary) 5%, transparent); }',
			...
			'.dsh-tb-manual-target { margin:0 0 10px; padding:7px 9px; color:var(--dsw-alias-brand-primary); border-radius:var(--dsw-alias-radius-sm, 6px); background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 86%, var(--dsw-alias-brand-primary)); font-size:11px; }',
			...
			'.dsh-tb-delete-summary { display:flex; flex-direction:column; gap:4px; margin:4px 0 10px; padding:9px 10px; border:1px solid color-mix(in srgb, var(--dsw-alias-state-error-primary) 45%, var(--dsw-alias-border-l1)); border-radius:var(--dsw-alias-radius-sm, 6px); background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 90%, var(--dsw-alias-state-error-primary)); }',
			...
			'.dsh-tb-manual-actions button { min-height:32px; padding:4px 12px; color:var(--dsw-alias-label-primary); border:1px solid var(--dsw-alias-border-l1); border-radius:var(--dsw-alias-radius-sm, 6px); background:transparent; cursor:pointer; }',
			'.dsh-tb-manual-actions button.dsh-tb-primary { color:var(--sanbao-on-accent); border-color:var(--sanbao-accent-fill); background:var(--sanbao-accent-fill); }',
			'.dsh-tb-manual-actions button.dsh-tb-danger { color:var(--dsw-alias-state-error-primary); border-color:var(--dsw-alias-state-error-primary); background:var(--sanbao-error-surface); }',
			'.dsh-tb-manual-actions button:disabled { opacity:.42; cursor:not-allowed; }',
			'.dsh-tb-panel, .dsh-tb-root-create, .dsh-tb-manual-dialog { background-color:var(--dsw-alias-bg-layer-1) !important; }',
			'.dsh-tb-shell button:focus-visible, .dsh-tb-shell input:focus-visible, .dsh-tb-shell textarea:focus-visible { outline:2px solid var(--dsw-alias-brand-primary); outline-offset:2px; }',
			'@media (prefers-reduced-motion: reduce) { .dsh-tb-card, .dsh-tb-card:hover { transition:none; transform:none; } }',
