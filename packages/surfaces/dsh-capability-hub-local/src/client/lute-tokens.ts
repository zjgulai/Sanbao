// Generated by scripts/sync-shared.mjs from shared/client/lute-tokens.ts. Do not edit this copy; edit the shared source and run "node scripts/sync-shared.mjs".
/**
