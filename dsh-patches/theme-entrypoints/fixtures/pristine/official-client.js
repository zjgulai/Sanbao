window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:F:\DSHPLU\desktop-2.0.9\deepseek-harness\packages\client\ui-theme\src\client\AppearanceRow.module.css.mjs
		const css$1 = ".Lmjdvq_group{border-bottom:.5px solid var(--dsw-alias-border-l2);flex-direction:column;gap:8px;padding:16px 0;display:flex}.Lmjdvq_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.Lmjdvq_cubeRow{flex-wrap:wrap;align-items:stretch;gap:8px;display:flex}.Lmjdvq_themeCube{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:20px;flex-direction:column;flex:180px;justify-content:center;align-items:center;gap:4px;padding:20px 32px;font-size:14px;line-height:22px;display:flex}.Lmjdvq_themeCube:hover:not(.Lmjdvq_selected){background:var(--dsw-alias-interactive-bg-hover)}.Lmjdvq_selected{background:var(--dsw-alias-bg-module-platform);border-color:var(--dsw-static-neutral-bluish-400)}";
		...
		var AppearanceRow_module_css_default = {
			"cubeRow": "Lmjdvq_cubeRow",
			"group": "Lmjdvq_group",
			"selected": "Lmjdvq_selected",
			"themeCube": "Lmjdvq_themeCube",
			"title": "Lmjdvq_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:F:\DSHPLU\desktop-2.0.9\deepseek-harness\packages\client\ui-theme\src\client\FontSizeRow.module.css.mjs
		const css = ".QEPGrW_row{border-bottom:.5px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.QEPGrW_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.QEPGrW_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.QEPGrW_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.QEPGrW_control{align-items:center;gap:8px;display:inline-flex}.QEPGrW_stepper{background:var(--dsw-alias-bg-module-platform);border-radius:18px;justify-content:center;align-items:center;min-width:72px;height:36px;display:inline-flex;position:relative}.QEPGrW_value{text-align:center;font-variant-numeric:tabular-nums;min-width:18px;color:var(--dsw-alias-label-primary);font-size:14px;line-height:22px}.QEPGrW_unit{color:var(--dsw-alias-label-secondary);font-size:14px;line-height:22px}.QEPGrW_arrows{opacity:0;flex-direction:column;gap:2px;display:flex;position:absolute;right:8px}.QEPGrW_stepper:hover .QEPGrW_arrows,.QEPGrW_stepper:focus-within .QEPGrW_arrows{opacity:1}.QEPGrW_arrow{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 75%, transparent);width:17px;height:12px;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:3px;justify-content:center;align-items:center;padding:0;display:inline-flex}.QEPGrW_arrow:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.QEPGrW_arrow:disabled{color:var(--dsw-alias-label-caption);cursor:default}";
		...
		var FontSizeRow_module_css_default = {
			"arrow": "QEPGrW_arrow",
			"arrows": "QEPGrW_arrows",
			"control": "QEPGrW_control",
			"desc": "QEPGrW_desc",
			"row": "QEPGrW_row",
			"rowText": "QEPGrW_rowText",
			"stepper": "QEPGrW_stepper",
			"title": "QEPGrW_title",
			"unit": "QEPGrW_unit",
			"value": "QEPGrW_value"
		};
		...
		*/
		...
		//#endregion
		//#region \0dsh-inline-css:F:\DSHPLU\desktop-2.0.9\deepseek-harness\packages\client\ui-theme\src\styles\base.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:F:\DSHPLU\desktop-2.0.9\deepseek-harness\packages\client\ui-theme\src\styles\corner-shape.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:F:\DSHPLU\desktop-2.0.9\deepseek-harness\packages\client\ui-theme\src\styles\design-platform.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:F:\DSHPLU\desktop-2.0.9\deepseek-harness\packages\client\ui-theme\src\styles\scrollbar.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:F:\DSHPLU\desktop-2.0.9\deepseek-harness\packages\client\ui-theme\src\styles\gradient-shadow-text.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:F:\DSHPLU\desktop-2.0.9\deepseek-harness\packages\client\ui-theme\src\styles\shiki.css.mjs
